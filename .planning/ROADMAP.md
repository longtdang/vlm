...
- [ ] **Phase 2: Pose Contract Mapping** - Users get deterministic keypoint and skeleton conversion with schema safety.
- [ ] **Phase 3: Visibility Fidelity** - Users retain absent/hidden/visible semantics and audit metadata after import.
...
| 2. Pose Contract Mapping | 0/TBD | Not started | - |
