...
| 06-02-01 | 02 | 2 | VER-03 | T-06-03 | CSV/JSON/NDJSON include per-rule details and failure reasons | integration | `pytest -q tests/phase6/test_reporting.py -x` | ✅ exists | ✅ green |
